...
const DownloadSelection = () => {
  ...
  const renderContent = () => {
    ...
    return contentArray.map((content, index) => (
        <div key={index} className="p-4 my-4 mx-2 bg-site-300-light dark:bg-site-300-dark text-white rounded-lg shadow-md col">
            <h3 className="text-2xl mb-2 text-black dark:text-white">{content.title}</h3>
            <p className='text-black dark:text-white'><strong>Download Size:</strong> {content.details.downloadSize}</p>
            <p className="mt-2 text-black dark:text-white"><strong>Kernel:</strong> <code>{content.details.kernel}</code></p>
            ...
            <div className="tooltip">
              <span className="tooltiptext text-black dark:text-white" id={content.title}>Copy to clipboard</span>
              <button
                onClick={() => {
  ...
  return (
    <div className="md:w-[85%] w-full mx-auto md:p-0 p-4">
      <h1 className="text-black dark:text-white text-center pt-8 text-3xl drop-shadow-header-drop">
        Download Rhino Linux
      </h1>
      <h2 className="text-black dark:text-white text-center text-2xl font-light mt-2 drop-shadow-header-drop">
        Version <b><b>2025.2</b></b>
      </h2>
      <div className="mx-2">
        <select
          id="platform"
          ...
          className="p-2 px-4 bg-site-300-light dark:bg-site-300-dark w-[100%] text-black dark:text-white select-fix md:text-2xl font-light rounded-[0.5em] mt-4 appearance-none"
        >
