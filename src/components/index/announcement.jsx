  ...
  return (
    <div className="flex bg-site-400 text-center justify-center text-md mt-8">
      <div className="w-[80vw] md:w-max bg-site-300 items-center justify-center text-indigo-100 leading-none rounded-[1.5em] pt-2 px-4" role="alert">
        ...
        <p className="inline-flex font-semibold mr-2 mt-2 text-center p-2">Rhino Linux 2025.3 out now!</p>
        <div className="inline-flex my-2 md:mt-0">
          <p className="text-off-white">
            ...
            <Link href="https://blog.rhinolinux.org/news-22" className="inline-flex leading-8 py-2 mx-2 text-center text-white hover:scale-105 hover:text-rhino-purple transition-all text-md">
                Announcement →
            </Link>
          </p>
        </div>
